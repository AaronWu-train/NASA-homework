...
% 頁首/頁尾設定 (fancyhdr)
\pagestyle{fancy}
\fancyhead[L]{NASA Homework 1} % 可以用 \leftmark 取代
...
\begin{problem}{2.} \textbf{Building a Merkle Tree}
  \begin{itemize}
    ...
    \item \href{https://man.archlinux.org/man/find.1.zh_TW#type}{find man page}
  \end{itemize}
\end{problem}
...
\begin{minipage}{0.49\textwidth}
  ...
  \begin{problem}{2.} \textbf{Build}
    \begin{itemize}
      \item 在本題中，我沒有使用到 chatGPT。
    \end{itemize}
  \end{problem}
\end{minipage}
\vrule width 0.2pt
...
\begin{minipage}{0.48\textwidth}
  \begin{problem}{3.} \textbf{Gen-Proof}
    \begin{figure}[H]
      \centering
...
\clearpage
\begin{problem}{4.} \textbf{Verify-Proof}
  \begin{figure}[H]
    \centering
