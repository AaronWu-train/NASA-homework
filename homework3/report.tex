...
\begin{mycolorbox}[teal]
  ...
  \begin{itemize}
    ...
    \item \href{https://www.manageengine.com/products/oputils/enable-snmp-cisco-router.html}{Enabling SNMP in Cisco Routers / Switches}
  \end{itemize}
\end{mycolorbox}
...
\end{minted}
之後，在跟隨指示操作，在 PC0 > Desktop > MIB Browser > Advanced 當中， Read Community 輸入 public， Write Community 輸入 private，並且輸入 Switch0 的 IP 位址，同時將 SNMP Version 改為 v2。最後，在 OID 欄位輸入 \texttt{.1.3.6.1.2.1.1.5.0}，即可查詢到 hostname。結果如下圖所示。
\begin{figure}[H]
  \centering
