...
\begin{mycolorbox}[teal]
  ...
  \begin{itemize}
    ...
    \item 詢問鄭竣陽得知 \texttt{traceroute} 要加上 \texttt{-I} 參數 (Problem 2.5)
      ...
      \item 新增以下規則，分別允許 VLAN 99 連線到防火牆的 \texttt{ADMIN\_PORTS} 和 \texttt{GOOGLE\_DNS}、\texttt{CSIE\_WS}。
        \begin{table}[H]
          ...
          \begin{tabular}{lllllll}
            ...
            \midrule
            Pass & In & IPv4 TCP/UDP & VLAN 99 net & * & This Firewall & \texttt{\footnotesize ADMIN\_PORTS} \\
            Pass & In & IPv4 * & VLAN 99 net & * & \texttt{\footnotesize CSIE\_WS, GOOGLE\_DNS} & * \\
            \bottomrule
          \end{tabular}
        \end{table}
    \end{enumerate}
...
\begin{enumerate}
  ...
  \begin{table}[H]
    ...
    \end{tabular}
  \end{table}
  \item 在 Firewall > Rules > [VLAN 11] 頁面，新增以下規則（加在 2.3 的規則之後）：
\end{enumerate}
% Problem 2.7
\subsection{}
