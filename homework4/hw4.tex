...
\begin{mycolorbox}[teal]
  ...
  \footnotesize
  \begin{itemize}
    \item \url{https://docs.opnsense.org/manual/install.html}
    \item \href{https://www.zenarmor.com/docs/network-security-tutorials/how-to-setup-dhcp-server-on-opnsense/}{How to Setup DHCP Server on OPNsense}
    \item 
    \item 
    \item 
    \item 
